...
Shader "MM/Holo"
{
	Properties
	{
		...
		[ASEBegin]_BackgroundStripe("Background Stripe", Color) = (0.6586773,0.5896226,1,1)
		...
		[ASEEnd]_TextAnimationSpeed("Text Animation Speed", Range( 1 , 10)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 _Details_ST;
			half4 _DetailsColor;
			half4 _BackgroundStripe;
			half4 _TextTexture_ST;
			half2 _IconTiling;
			half2 _IconOffsetLeft;
			half2 _IconOffsetRight;
			half _BackgroundStripeSpeed;
			half _TextAnimationSpeed;
			half _TextAnimation;
			half _BorderWidth;
			half _Iconscrollingspeed;
			...
			CBUFFER_END
			TEXTURE2D(_Dots);
			SAMPLER(sampler_Dots);
			TEXTURE2D(_Details);
			SAMPLER(sampler_Details);
			TEXTURE2D(_TextTexture);
			SAMPLER(sampler_TextTexture);
			TEXTURE2D(_Icon);
			SAMPLER(sampler_Icon);
						 ...
						 ) : SV_Target
			{
				...
				half2 uv_Dots = IN.ase_texcoord7.xy * _Dots_ST.xy + _Dots_ST.zw;
				half2 panner86 = ( _TimeParameters.x * half2( 0,0.2 ) + uv_Dots);
				half4 Dots79 = ( _Dotcolor * _Dotcolor.a * SAMPLE_TEXTURE2D( _Dots, sampler_Dots, panner86 ) );
				half2 uv_Details = IN.ase_texcoord7.xy * _Details_ST.xy + _Details_ST.zw;
				half2 panner129 = ( _TimeParameters.x * half2( 0.1,0 ) + uv_Details);
				half4 Details135 = ( SAMPLE_TEXTURE2D( _Details, sampler_Details, panner129 ) * _DetailsColor * IN.ase_color.a );
				half2 break19_g13 = float2( -0.5,-0.5 );
				half temp_output_1_0_g13 = ( ( ( _TimeParameters.x * _BackgroundStripeSpeed ) + WorldPosition.y ) * 160.0 );
				half sinIn7_g13 = sin( temp_output_1_0_g13 );
				half sinInOffset6_g13 = sin( ( temp_output_1_0_g13 + 1.0 ) );
				half lerpResult20_g13 = lerp( break19_g13.x , break19_g13.y , frac( ( sin( ( ( sinIn7_g13 - sinInOffset6_g13 ) * 91.2228 ) ) * 43758.55 ) ));
				half4 Base168 = ( _BackgroundStripe * _BackgroundStripe.a * ( saturate( ( lerpResult20_g13 + sinIn7_g13 ) ) + saturate( ( pow( frac( ( ( ( _TimeParameters.x * ( _BackgroundStripeSpeed + 0.01 ) ) + WorldPosition.y ) * 5.0 ) ) , 0.48 ) + -0.5 ) ) ) );
				half2 uv_TextTexture = IN.ase_texcoord7.xy * _TextTexture_ST.xy + _TextTexture_ST.zw;
				half4 temp_cast_0 = (( ( ( 1.0 - abs( _TimeParameters.z ) ) * _TextAnimationSpeed ) + (( _TextAnimation )?( 0.0 ):( 100.0 )) )).xxxx;
				half4 blendOpSrc184 = SAMPLE_TEXTURE2D( _TextTexture, sampler_TextTexture, uv_TextTexture );
				half4 blendOpDest184 = temp_cast_0;
				half2 texCoord92 = IN.ase_texcoord7.xy * float2( 21.7,4 ) + float2( 0,0 );
				half2 panner125 = ( _TimeParameters.x * float2( 0,0.4 ) + texCoord92);
				float cos95 = cos( 0.0 * _Time.y );
				float sin95 = sin( 0.0 * _Time.y );
				half2 rotator95 = mul( panner125 - float2( 0,0 ) , float2x2( cos95 , -sin95 , sin95 , cos95 )) + float2( 0,0 );
				float cos101 = cos( 4.0 );
				float sin101 = sin( 4.0 );
				half2 rotator101 = mul( rotator95 - float2( 0,0 ) , float2x2( cos101 , -sin101 , sin101 , cos101 )) + float2( 0,0 );
				half2 appendResult10_g11 = (half2(10.64 , 0.24));
				half2 temp_output_11_0_g11 = ( abs( (frac( rotator101 )*2.0 + -1.0) ) - appendResult10_g11 );
				half2 break16_g11 = ( 1.0 - ( temp_output_11_0_g11 / fwidth( temp_output_11_0_g11 ) ) );
				half2 texCoord45 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				half2 appendResult10_g10 = (half2(1.0 , ( 1.0 - _BorderWidth )));
				half2 temp_output_11_0_g10 = ( abs( (texCoord45*2.0 + -1.0) ) - appendResult10_g10 );
				half2 break16_g10 = ( 1.0 - ( temp_output_11_0_g10 / fwidth( temp_output_11_0_g10 ) ) );
				half TopBottomLines50 = ( ( 1.0 - saturate( min( break16_g11.x , break16_g11.y ) ) ) * ( 1.0 - saturate( min( break16_g10.x , break16_g10.y ) ) ) );
				half4 Text154 = ( ( ( saturate( min( blendOpSrc184 , blendOpDest184 ) )) + TopBottomLines50 ) * IN.ase_color * IN.ase_color.a );
				half4 appendResult139 = (half4(0.0 , _Iconscrollingspeed , 0.0 , 0.0));
				half2 texCoord142 = IN.ase_texcoord7.xy * _IconTiling + _IconOffsetLeft;
				half2 panner144 = ( _TimeParameters.x * appendResult139.xy + texCoord142);
				half2 texCoord140 = IN.ase_texcoord7.xy * _IconTiling + _IconOffsetRight;
				half2 panner143 = ( _TimeParameters.x * appendResult139.xy + texCoord140);
				half4 Icon151 = ( ( SAMPLE_TEXTURE2D( _Icon, sampler_Icon, panner144 ) + SAMPLE_TEXTURE2D( _Icon, sampler_Icon, panner143 ) ) * IN.ase_color * IN.ase_color.a );
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( Dots79 + Details135 + ( ( Base168 + Text154 + Icon151 ) * _ColorIntensity ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 uv_Dots = IN.ase_texcoord2.xy * _Dots_ST.xy + _Dots_ST.zw;
				half2 panner86 = ( _TimeParameters.x * half2( 0,0.2 ) + uv_Dots);
				half4 Dots79 = ( _Dotcolor * _Dotcolor.a * SAMPLE_TEXTURE2D( _Dots, sampler_Dots, panner86 ) );
				half2 uv_Details = IN.ase_texcoord2.xy * _Details_ST.xy + _Details_ST.zw;
				half2 panner129 = ( _TimeParameters.x * half2( 0.1,0 ) + uv_Details);
				half4 Details135 = ( SAMPLE_TEXTURE2D( _Details, sampler_Details, panner129 ) * _DetailsColor * IN.ase_color.a );
				half2 break19_g13 = float2( -0.5,-0.5 );
				half temp_output_1_0_g13 = ( ( ( _TimeParameters.x * _BackgroundStripeSpeed ) + WorldPosition.y ) * 160.0 );
				...
				half lerpResult20_g13 = lerp( break19_g13.x , break19_g13.y , frac( ( sin( ( ( sinIn7_g13 - sinInOffset6_g13 ) * 91.2228 ) ) * 43758.55 ) ));
				half4 Base168 = ( _BackgroundStripe * _BackgroundStripe.a * ( saturate( ( lerpResult20_g13 + sinIn7_g13 ) ) + saturate( ( pow( frac( ( ( ( _TimeParameters.x * ( _BackgroundStripeSpeed + 0.01 ) ) + WorldPosition.y ) * 5.0 ) ) , 0.48 ) + -0.5 ) ) ) );
				half2 uv_TextTexture = IN.ase_texcoord2.xy * _TextTexture_ST.xy + _TextTexture_ST.zw;
				half4 temp_cast_0 = (( ( ( 1.0 - abs( _TimeParameters.z ) ) * _TextAnimationSpeed ) + (( _TextAnimation )?( 0.0 ):( 100.0 )) )).xxxx;
				half4 blendOpSrc184 = SAMPLE_TEXTURE2D( _TextTexture, sampler_TextTexture, uv_TextTexture );
				half4 blendOpDest184 = temp_cast_0;
				half2 texCoord92 = IN.ase_texcoord2.xy * float2( 21.7,4 ) + float2( 0,0 );
				half2 panner125 = ( _TimeParameters.x * float2( 0,0.4 ) + texCoord92);
				float cos95 = cos( 0.0 * _Time.y );
				float sin95 = sin( 0.0 * _Time.y );
				half2 rotator95 = mul( panner125 - float2( 0,0 ) , float2x2( cos95 , -sin95 , sin95 , cos95 )) + float2( 0,0 );
				...
				half2 temp_output_11_0_g11 = ( abs( (frac( rotator101 )*2.0 + -1.0) ) - appendResult10_g11 );
				half2 break16_g11 = ( 1.0 - ( temp_output_11_0_g11 / fwidth( temp_output_11_0_g11 ) ) );
				half2 texCoord45 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				half2 appendResult10_g10 = (half2(1.0 , ( 1.0 - _BorderWidth )));
				half2 temp_output_11_0_g10 = ( abs( (texCoord45*2.0 + -1.0) ) - appendResult10_g10 );
				half2 break16_g10 = ( 1.0 - ( temp_output_11_0_g10 / fwidth( temp_output_11_0_g10 ) ) );
				half TopBottomLines50 = ( ( 1.0 - saturate( min( break16_g11.x , break16_g11.y ) ) ) * ( 1.0 - saturate( min( break16_g10.x , break16_g10.y ) ) ) );
				half4 Text154 = ( ( ( saturate( min( blendOpSrc184 , blendOpDest184 ) )) + TopBottomLines50 ) * IN.ase_color * IN.ase_color.a );
				half4 appendResult139 = (half4(0.0 , _Iconscrollingspeed , 0.0 , 0.0));
				half2 texCoord142 = IN.ase_texcoord2.xy * _IconTiling + _IconOffsetLeft;
				half2 panner144 = ( _TimeParameters.x * appendResult139.xy + texCoord142);
				half2 texCoord140 = IN.ase_texcoord2.xy * _IconTiling + _IconOffsetRight;
				half2 panner143 = ( _TimeParameters.x * appendResult139.xy + texCoord140);
				half4 Icon151 = ( ( SAMPLE_TEXTURE2D( _Icon, sampler_Icon, panner144 ) + SAMPLE_TEXTURE2D( _Icon, sampler_Icon, panner143 ) ) * IN.ase_color * IN.ase_color.a );
...
/*ASEBEGIN
Version=18935
7;6;1906;1013;2476.917;1331.567;3.077405;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-1288.657,-1983.23;Inherit;False;Property;_BackgroundStripeSpeed;Background Stripe Speed;2;0;Create;True;0;0;0;False;0;False;0.1;0;0;0.3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-901.1583,-1409.309;Inherit;False;Constant;_Angle;Angle;6;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;176;-958.307,-1313.301;Inherit;False;Property;_BorderWidth;Border Width;3;0;Create;True;0;0;0;False;0;False;0.0836124;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;93;-456.9322,-1526.994;Inherit;False;Rectangle;-1;;11;6b23e0c975270fb4084c354b2c83366a;0;3;1;FLOAT2;0,0;False;2;FLOAT;10.64;False;3;FLOAT;0.24;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;203;-1335.524,1454.133;Inherit;False;Property;_IconOffsetLeft;Icon Offset Left;12;0;Create;True;0;0;0;False;0;False;-0.1,0;-0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;138;-1353.16,1735.726;Inherit;False;Property;_Iconscrollingspeed;Icon scrolling speed;14;0;Create;True;0;0;0;False;0;False;0.1;0;0;0.3;0;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;16;-518.8412,-1754.053;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;196;-928.4615,-849.8943;Inherit;False;Property;_TextAnimationSpeed;Text Animation Speed;18;0;Create;True;0;0;0;False;0;False;1;1;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;137;-1218.921,1651.563;Inherit;False;Constant;_Scrollingspeed0;Scrolling speed 0;12;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;204;-1347.524,1902.133;Inherit;False;Property;_IconOffsetRight;Icon Offset Right;13;0;Create;True;0;0;0;False;0;False;-0.1,0;-0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;175;-1357.081,1609.387;Inherit;False;Property;_IconTiling;Icon Tiling;11;0;Create;True;0;0;0;False;0;False;6,1;6,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ToggleSwitchNode;191;-622.871,-873.7591;Inherit;False;Property;_TextAnimation;Text Animation;17;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;100;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;32;-1338.122,-1153.711;Inherit;True;Property;_TextTexture;Text Texture;7;0;Create;True;0;0;0;False;0;False;None;c4d9cae8e4caf430382d2d5932f601b4;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;145;-840.5029,1451.351;Inherit;True;Property;_Icon;Icon;10;0;Create;True;0;0;0;False;0;False;b2f0d410e71b143d882f958158712f86;b2f0d410e71b143d882f958158712f86;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;7;-499.669,-2069.812;Inherit;False;Noise Sine Wave;-1;;13;a6eff29f739ced848846e3b648af87bd;0;2;1;FLOAT;0;False;2;FLOAT2;-0.5,-0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;36;-1110.005,-1154.23;Inherit;True;Property;_TextureSample0;Texture Sample 0;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;147;-588.6454,1587.189;Inherit;True;Property;_TextureSample4;Texture Sample 4;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;126;-1300.465,1091.349;Inherit;False;Constant;_DetailsSpeed;Details Speed;5;0;Create;True;0;0;0;False;0;False;0.1,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;12;-17.60949,-2092.768;Inherit;False;Property;_BackgroundStripe;Background Stripe;1;0;Create;True;0;0;0;False;0;False;0.6586773,0.5896226,1,1;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;83;-1277.691,-541.1548;Inherit;False;Constant;_DotPanner;Dot Panner;5;0;Create;True;0;0;0;False;0;False;0,0.2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;87;-1081.151,-686.1769;Inherit;True;Property;_Dots;Dots;5;0;Create;True;0;0;0;False;0;False;c08a999c2bb384a1793f9225a3154e61;c08a999c2bb384a1793f9225a3154e61;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;130;-1347.827,767.4884;Inherit;True;Property;_Details;Details;8;0;Create;True;0;0;0;False;0;False;b0cc20c9266a34c57a3dd0670464741e;b0cc20c9266a34c57a3dd0670464741e;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;132;-890.9706,773.6871;Inherit;True;Property;_TextureSample5;Texture Sample 5;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;131;-889.6925,978.1385;Inherit;False;Property;_DetailsColor;Details Color;9;0;Create;True;0;0;0;False;0;False;0.2783019,0.5532672,1,0.3686275;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;90;-818.4024,-515.1262;Inherit;True;Property;_TextureSample2;Texture Sample 2;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;89;-820.8947,-681.3796;Inherit;False;Property;_Dotcolor;Dot color;6;0;Create;True;0;0;0;False;0;False;0.4150943,0.4150943,0.4150943,1;0,0,0,0.3254902;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;172;921.0773,190.6272;Inherit;False;Property;_ColorIntensity;Color Intensity;4;0;Create;True;0;0;0;False;0;False;1;1;1;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;117;-302.0128,278.6221;Inherit;False;Constant;_Zero;Zero;3;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.SimpleTimeNode;104;-1319.701,477.0537;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;103;-1323.584,360.3975;Inherit;False;Random Range;-1;;12;7b754edb8aebbfb4a9ace907af661cfc;0;3;1;FLOAT2;0,6;False;2;FLOAT;0;False;3;FLOAT;6;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;109;-1156.492,565.5883;Inherit;False;Constant;_Noisesize;Noise size;7;0;Create;True;0;0;0;False;0;False;3;0.49;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;119;-1336.826,-171.0882;Inherit;True;Property;_Displacement;Displacement;15;0;Create;True;0;0;0;False;0;False;6824678ccb0ef400ea97cf66d7bf0b56;6824678ccb0ef400ea97cf66d7bf0b56;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;114;-1021.069,-73.58514;Inherit;True;Property;_TextureSample8;Texture Sample 8;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-1000.439,137.374;Inherit;False;Property;_Glitchspeed;Glitch speed;16;0;Create;True;0;0;0;False;0;False;0.01;0.0041;0;0.03;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;211;1558.404,-266.1772;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;205;1558.404,-266.1772;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;206;1558.404,-266.1772;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;MM/Holo;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;8;False;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;207;1558.404,-266.1772;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;208;1558.404,-266.1772;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;209;1558.404,-266.1772;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;210;1558.404,-266.1772;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;212;1558.404,-266.1772;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;206;2;18;0
ASEEND*/
//CHKSM=BF8482320DE7EA9CAAF68C56088D79052EDBA7D8